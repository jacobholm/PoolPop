...
VS_OUTPUT vs_vertexshader(VS_INPUT input)
{
    ...
    output.Reflection[0] = -output.Reflection[0];			// Flip along the y-axis, since the environmentmap becomes flipped when put on the cubemap
...
float4 ps_pixelshader(PS_INPUT input) : COLOR0
{
